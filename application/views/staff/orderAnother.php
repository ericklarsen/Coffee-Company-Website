...
<div class="container-fluid" id="container-wrapper">
    ...
    <!-- <a href="<?php echo base_url() . 'staff/menu_orderAnother/add'; ?>" type="button" class="btn btn-primary mb-1">Add Order</a> -->
    <br>
    <br>
...
<script>
    $(document).ready(function() {
        $('#dataTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('staff/orderAnother/pagination'); ?>",
                "type": "POST"
            },
            "order": [],
            "lengthMenu": [
