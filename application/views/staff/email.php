                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        <h2>Hi, <?= $nama_pemesan;?></h2>
                                        <h3>Berikut adalah detail pemesanan anda</h3>
                                        <p>Kami akan segera menghubungi anda melalui WhatsApp untuk info lebih lanjut.</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                                <div class="product-entry">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>Roasted Note : <?php if(empty($roasted_level_note)) { echo  '-';}else{ echo $roasted_level_note;} ?></p>
                                    </div>
                                </div>
                            </td>
                        </tr>
