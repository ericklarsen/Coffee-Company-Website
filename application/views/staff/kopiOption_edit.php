    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="<?= base_url() . 'staff/menu_kopiOption/edit_action' ?>" method="POST">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Name</label>
                            <input type="text" name="name" class="form-control" value="<?= $data->name;?>">
                            <input type="hidden" name="id_kopiOption" class="form-control" value="<?= $data->id_kopiOption;?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="desc_kopiOption" rows="10"><?= $data->description;?></textarea>
                        </div>
