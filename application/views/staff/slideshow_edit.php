    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" action="<?= base_url().'staff/menu_slideshow/edit_action'?>" method="POST">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <textarea class="form-control" name="description_slideshow" rows="10"><?= $data->description;?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="cover_slideshow_old" value="<?= $data->cover_slideshow;?>">
                            <input type="hidden" name="id_slideshow" value="<?= $data->id_slideshow;?>">
                            <br><img id="output" width="300px" src="<?= base_url().'assets_upload/slideshow/'.$data->cover_slideshow;?>"><br>
